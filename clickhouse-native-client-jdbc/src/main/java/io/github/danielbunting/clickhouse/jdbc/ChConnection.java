...
public final class ChConnection implements Connection {
    ...
    /** Rejects null SQL up front with the spec-mandated {@link SQLException}. */
    ...
    /**
     * Closed-connection guard for the client-info setters, which may only throw
     * {@link SQLClientInfoException} (so {@code checkOpen()} cannot be reused).
     */
    private void checkOpenForClientInfo() throws SQLClientInfoException {
        if (closed) {
